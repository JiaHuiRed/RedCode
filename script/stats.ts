...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/JiaHuiRed/redcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for JiaHuiRed/redcode...\n")
...
console.log("Fetching npm all-time downloads for redcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("redcode-ai")
