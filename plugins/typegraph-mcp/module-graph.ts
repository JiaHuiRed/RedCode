...
export async function buildGraph(projectRoot: string, tsconfigPath: string): Promise<BuildGraphResult> {
...
export function updateFile(graph: ModuleGraph, filePath: string, resolver: ResolverFactory, projectRoot: string): void {
