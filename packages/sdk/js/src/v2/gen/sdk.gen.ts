...
export class Project extends HeyApiClient {
   ...
   * Remove project
   *
   * Permanently remove a project record from the database.
   */
  public remove<ThrowOnError extends boolean = false>(
    parameters: {
      projectID: string
...
export class Provider extends HeyApiClient {
  ...
  /**
   * Get current quota snapshots
   *
   * Return the latest quota snapshots captured from provider response headers.
   */
...
export class Session2 extends HeyApiClient {
  ...
  public tts<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<SessionTtsResponses, SessionTtsErrors, ThrowOnError>({
      url: "/session/tts",
      ...options,
      ...params,
      headers: {
