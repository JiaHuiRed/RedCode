...
class Database extends Context.Service<Database, DatabaseShape>()("@redcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@redcode/example/UserStore") {
