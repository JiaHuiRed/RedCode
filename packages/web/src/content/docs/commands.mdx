...
Create `.redcode/commands/test.md`:

```md title=".redcode/commands/test.md"
---
...
You can add custom commands through the RedCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your RedCode [config](/docs/config):

```json title="redcode.jsonc" {4-12}
{
...
- Global: `~/.redcode/commands/`
- Per-project: `.redcode/commands/`

```markdown title="~/.redcode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".redcode/commands/component.md"
---
...
```md title=".redcode/commands/create-file.md"
---
...
```md title=".redcode/commands/analyze-coverage.md"
---
...
```md title=".redcode/commands/review-changes.md"
---
...
```md title=".redcode/commands/review-component.md"
---
...
redcode includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
