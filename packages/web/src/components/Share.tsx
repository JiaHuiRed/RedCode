...
import type { Session } from "redcode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.redcode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.redcode_name}>
