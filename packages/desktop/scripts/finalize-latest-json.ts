...
const releaseId = process.env.REDCODE_RELEASE
if (!releaseId) throw new Error("REDCODE_RELEASE is required")

const version = process.env.REDCODE_VERSION
if (!version) throw new Error("REDCODE_VERSION is required")
...
const macxTarGz = "redcode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "redcode-desktop-mac-arm64.app.tar.gz"
