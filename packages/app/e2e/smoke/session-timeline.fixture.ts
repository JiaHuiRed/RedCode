...
const directory = "C:/RedCode/SmokeProject"
const projectID = "proj_smoke_timeline"
const model = { providerID: "redcode", modelID: "claude-opus-4-6", variant: "max" }
...
export const fixture = {
  ...
  provider: {
    ...
    connected: ["redcode"],
    default: { providerID: "redcode", modelID: "claude-opus-4-6" },
  },
  sessions: [
    {
      id: sourceID,
