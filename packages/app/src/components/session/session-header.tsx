...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_REDCODE_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("redcode-titlebar-center"))
    setRightMount(document.getElementById("redcode-titlebar-right"))
  })
