export const dict = {
  ...
  "dialog.provider.RedCode.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.RedCode.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.RedCodeGo.tagline": "Недорога підписка для всіх",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.RedCodeZen.visit.prefix": "Відвідайте ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": ", щоб отримати ключ API.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в RedCode.json",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (RedCode.json)",
