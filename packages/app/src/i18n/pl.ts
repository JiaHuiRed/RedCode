export const dict = {
  ...
  "dialog.provider.RedCode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.RedCode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.RedCodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.RedCodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w RedCode.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (RedCode.json) nazwy dostawców/modeli",
