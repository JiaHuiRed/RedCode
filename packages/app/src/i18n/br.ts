export const dict = {
  ...
  "dialog.provider.RedCode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.RedCode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.RedCodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.RedCodeZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.RedCodeZen.visit.prefix": "Visite ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " para obter sua chave de API.",
  ...
  "dialog.plugins.empty": "Plugins configurados em RedCode.json",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (RedCode.json)",
