export const dict = {
  ...
  "dialog.provider.RedCode.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.RedCode.tagline": "Надежные оптимизированные модели",
  "dialog.provider.RedCodeGo.tagline": "Доступная подписка для всех",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в RedCode.",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.RedCodeZen.visit.prefix": "Посетите ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " чтобы получить ваш API ключ.",
  ...
  "dialog.plugins.empty": "Плагины настроены в RedCode.json",
  ...
  "dialog.server.description": "Переключите сервер RedCode к которому подключается приложение.",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (RedCode.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что RedCode пока не поддерживает MCP авторизацию.',
  ...
  "settings.general.row.appearance.description": "Настройте как RedCode выглядит на вашем устройстве",
