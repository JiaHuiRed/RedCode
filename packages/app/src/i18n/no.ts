...
export const dict = {
  ...
  "dialog.provider.RedCode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.RedCode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.RedCodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i RedCode.",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.RedCodeZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.RedCodeZen.visit.prefix": "Besøk ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i RedCode.json",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (RedCode.json)",
  ...
  "settings.general.row.colorScheme.description": "Velg om RedCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan RedCode er tematisert.",
