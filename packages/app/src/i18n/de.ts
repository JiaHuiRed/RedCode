...
export const dict = {
  ...
  "dialog.provider.RedCode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.RedCode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.RedCodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in RedCode zu nutzen.",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.RedCodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  ...
  "dialog.plugins.empty": "In RedCode.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (RedCode.json) auf Anbieter-/Modellnamen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von RedCode.",
