...
export const dict = {
  ...
  "session.new.greeting.morning.a": "早上好，今天想从哪儿开始？",
  "session.new.greeting.morning.b": "早上好呀，泡杯茶，我们开工",
  "session.new.greeting.noon.a": "中午好，先垫两口再说？",
  "session.new.greeting.noon.b": "中午好呀，歇一会儿不耽误事",
  "session.new.greeting.afternoon.a": "下午好，接下来交给我",
  "session.new.greeting.afternoon.b": "下午好呀，趁着状态正好",
  "session.new.greeting.evening.a": "晚上好，今天还剩点什么没收尾？",
  "session.new.greeting.evening.b": "晚上好呀，慢慢来，不着急",
  "session.new.greeting.night.a": "夜深了，别熬太久",
  "session.new.greeting.night.b": "这个点还在写？我陪你",
