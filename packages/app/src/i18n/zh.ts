...
export const dict = {
  ...
  "command.session.busyEnter": "切换繁忙时消息送达",
  "command.session.busyEnter.description": "插话（立即送达模型）↔ 排队（等本轮结束）",
  "toast.busyEnter.steer.title": "已切换为插话",
  "toast.busyEnter.steer.description": "繁忙时发的消息在下个工具调用后立即送达模型",
  "toast.busyEnter.queue.title": "已切换为排队",
  "toast.busyEnter.queue.description": "繁忙时发的消息等本轮结束后作为新一轮输入",
  "toast.busyEnter.failed": "切换失败，请检查后端连接",
  "settings.general.row.image.title": "生图后端",
  ...
  "settings.general.row.busyEnter.queue": "排队（等本轮结束）",
  ...
  "dialog.provider.RedCode.note": "使用 RedCode Zen 或 API 密钥连接",
  "dialog.provider.RedCode.tagline": "可靠的优化模型",
  "dialog.provider.RedCodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 RedCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.RedCodeZen.line1": "RedCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.RedCodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.RedCodeZen.visit.prefix": "访问 ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 RedCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 RedCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 RedCode.json 中配置的插件",
  ...
  "context.quota.empty": "尚无额度记录——下一次供应商请求后会显示",
  ...
  "context.stats.inputTokens": "输入（未命中）",
  ...
  "error.chain.resources": "项目占用的系统资源不足，请关闭不用的项目后重试。",
  "error.chain.processStart": "项目辅助进程无法启动，请关闭不用的项目后重试。",
  "error.chain.modelNotFound": "未找到模型：{{provider}}/{{model}}",
  "error.chain.checkConfig": "请检查你的配置 (RedCode.json) 中的 provider/model 名称",
  ...
  "notification.compacted.title": "上下文已压缩",
  "notification.compacted.description": "从 {{before}} 压缩到 {{after}}",
  ...
  "home.view.list": "列表视图",
  "home.view.kanban": "看板视图",
  "home.kanban.working": "工作中",
  "home.kanban.attention": "需关注",
  "home.kanban.idle": "空闲",
  "home.kanban.empty": "暂无会话",
  "home.kanban.compacting": "压缩中",
  "home.kanban.hidden": "另有 {{count}} 个较早会话未显示",
  "home.usage.tab.overview": "总览",
  "home.usage.tab.models": "模型",
  "home.usage.collapse": "收起用量",
  "home.usage.expand": "显示用量",
  "home.usage.range.all": "全部",
  "home.usage.range.30d": "30 天",
  "home.usage.range.7d": "7 天",
  "home.usage.tile.sessions": "会话数",
  "home.usage.tile.messages": "请求数",
  "home.usage.tile.output": "产出 Token",
  "home.usage.tile.cacheRead": "缓存读取",
  "home.usage.tile.activeDays": "活跃天数",
  "home.usage.tile.currentStreak": "当前连续",
  "home.usage.tile.longestStreak": "最长连续",
  "home.usage.tile.peakHour": "峰值时段",
  "home.usage.days": "{{count}} 天",
  "home.usage.other": "其他",
  ...
  "session.tab.plan": "计划",
  "session.tab.outline": "轮次",
  "session.outline.loading": "正在读取轮次目录…",
  ...
  "session.plan.progress": "已完成 {{done}}/{{total}}",
  "session.goal.title": "钉住的目标",
  "session.goal.status.active": "进行中",
  "session.goal.status.done": "已完成",
  "session.goal.status.blocked": "受阻",
  "session.goal.status.budget_limited": "预算用尽",
  "session.goal.status.cleared": "已清除",
  "session.goal.used": "该目标已用 {{tokens}} tokens",
  "session.goal.budget": "{{used}} / {{budget}} tokens · 自动续跑第 {{turn}}/{{max}} 轮",
  "session.plan.empty": "暂无计划步骤",
  "session.plan.inProgress": "进行中",
  "session.plan.done": "已完成",
  "session.plan.pending": "待处理",
  ...
  "greeting.morning.a": "早上好，今天想从哪儿开始？",
  "greeting.morning.b": "早上好呀，泡杯茶，我们开工",
  "greeting.morning.c": "早安，新的一天，从哪行代码开始？",
  "greeting.morning.d": "早上好呀，昨天留的现场还热乎着",
  "greeting.morning.e": "起床啦？趁脑子清醒先啃硬骨头",
  "greeting.morning.f": "早呀，咖啡或茶选一个，我们开工",
  "greeting.morning.g": "早上好，今天想先收拾哪一块？",
  "greeting.morning.h": "晨光正好，存档点已就位",
  "greeting.noon.a": "中午好，先垫两口再说？",
  "greeting.noon.b": "中午好呀，歇一会儿不耽误事",
  "greeting.noon.c": "中午好，干饭要紧，代码不急",
  "greeting.noon.d": "午安，吃完回来正好接着调",
  "greeting.noon.e": "中午好呀，屏幕和你都该歇十分钟",
  "greeting.noon.f": "到饭点了，放下键盘，饭菜不等人",
  "greeting.noon.g": "中午好，先吃饱，灵感才有力气来",
  "greeting.noon.h": "中午突击进度？可以，但记得吃饭",
  "greeting.afternoon.a": "下午好，接下来交给我",
  "greeting.afternoon.b": "下午好呀，趁着状态正好",
  "greeting.afternoon.c": "下午好，来杯续命水继续推进",
  "greeting.afternoon.d": "下午茶时间到，顺手把进度也推一推",
  "greeting.afternoon.e": "下午好，困了就说，我放慢点节奏",
  "greeting.afternoon.f": "趁下午还长，把上午挖的坑填了",
  "greeting.afternoon.g": "下午好，状态还在，再来一个需求",
  "greeting.afternoon.h": "午后好时光，最适合清任务清单",
  "greeting.evening.a": "晚上好，今天还剩点什么没收尾？",
  "greeting.evening.b": "晚上好呀，慢慢来，不着急",
  "greeting.evening.c": "晚上好呀，收工前还想做点什么？",
  "greeting.evening.d": "睡前记得把今天的改动提交了",
  "greeting.evening.e": "晚上好，加班费没有，陪伴管够",
  "greeting.evening.f": "夜幕降临，正好处理白天没敢动的重构",
  "greeting.evening.g": "晚上好呀，饭吃了吗？先吃饭",
  "greeting.evening.h": "忙了一天，剩下的事交给我收尾",
  "greeting.night.a": "夜深了，别熬太久",
  "greeting.night.b": "这个点还在写？我陪你",
  "greeting.night.c": "这么晚还没睡？最后一条，改完就睡",
  "greeting.night.d": "深夜好时光，安静，适合抓真 bug",
  "greeting.night.e": "夜深了，记得保存，明早再看也许更好",
  "greeting.night.f": "还在调试？早点休息，bug 又不会跑",
  "greeting.night.g": "夜猫子模式已启动，陪你到收工",
  "greeting.night.h": "凌晨的灵感很贵，但身体更贵，适度呀",
  ...
  "settings.general.row.fontSize.description": "调节界面整体使用的字号（基准 14px）",
  ...
  "settings.agents.model.description": "不覆盖时子代理用它自带的模型，主智能体跟随会话主模型",
