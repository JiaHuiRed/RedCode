...
export const dict = {
  ...
  "dialog.provider.RedCode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.RedCode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.RedCodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve RedCode'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.RedCodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve RedCode'da {{provider}} modellerini kullanmak için ",
  ...
  "dialog.plugins.empty": "Eklentiler RedCode.json içinde yapılandırılır",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı RedCode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (RedCode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: RedCode henüz MCP kimlik doğrulamasını desteklemiyor.',
