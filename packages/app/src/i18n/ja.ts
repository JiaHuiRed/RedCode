export const dict = {
  ...
  "command.session.unarchive": "アーカイブ解除",
  "home.sessions.archived.toggle": "アーカイブ済みを表示",
  "home.sessions.archived.empty": "アーカイブ済みのセッションはありません",
  ...
  "command.session.busyEnter": "実行中メッセージの送達を切替",
  "command.session.busyEnter.description": "割り込み（即時送達）↔ キュー（ターン終了まで待機）",
  "toast.busyEnter.steer.title": "割り込みに切替",
  "toast.busyEnter.steer.description": "実行中に送ったメッセージは次のステップでモデルに届きます",
  "toast.busyEnter.queue.title": "キューに切替",
  "toast.busyEnter.queue.description": "実行中に送ったメッセージはターン終了後に新しいターンとして処理されます",
  "toast.busyEnter.failed": "切替に失敗しました。バックエンド接続を確認してください",
  "settings.general.row.image.title": "画像バックエンド",
  "settings.general.row.image.description": "画像ツールが呼び出す API。プロバイダの切り替えは設定だけで済みます。",
  "settings.general.row.image.custom": "カスタム",
  "settings.general.row.imageEndpoint.title": "画像エンドポイント",
  "settings.general.row.imageEndpoint.description":
    "ベース URL、モデル ID、キーを取る auth エントリ。キー自体はここに保存しません（auth か REDCODE_IMAGE_API_KEY）。",
  "settings.general.row.busyEnter.title": "実行中メッセージの送達",
  "settings.general.row.busyEnter.description": "エージェント実行中に送ったメッセージの扱い。即時反映",
  "settings.general.row.busyEnter.steer": "割り込み（即時送達）",
  "settings.general.row.busyEnter.queue": "キュー（ターン終了まで待機）",
  ...
  "dialog.provider.RedCode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.RedCode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.RedCodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.RedCodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.RedCodeZen.visit.prefix": " ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "RedCode.jsonで設定されたプラグイン",
  ...
  "context.summary.cacheHit": "キャッシュヒット",
  ...
  "context.quota.empty": "残量記録はまだありません — 次のプロバイダーリクエスト後に表示されます",
  ...
  "session.panel.expand": "パネルを展開",
  "session.panel.collapse": "パネルを折りたたむ",
  ...
  "greeting.morning.a": "おはようございます。どこから始めましょうか？",
  "greeting.morning.b": "おはよう。お茶でも淹れて、始めましょう",
  "greeting.morning.c": "おはよう。今日はどの行から始めますか？",
  "greeting.morning.d": "おはよう。昨日の現場はまだ温かいですよ",
  "greeting.morning.e": "もう起きた？頭が動くうちに難しいものから",
  "greeting.morning.f": "おはよう。コーヒーかお茶、どちらにしますか",
  "greeting.morning.g": "おはようございます。今日はまずどれを片付けますか？",
  "greeting.morning.h": "朝の光がちょうどいい。セーブポイント準備完了",
  "greeting.noon.a": "こんにちは。先に何か食べますか？",
  "greeting.noon.b": "お昼ですね。少し休んでも大丈夫です",
  "greeting.noon.c": "お昼ですね。ごはんが先、コードは急ぎません",
  "greeting.noon.d": "ランチタイム。bug は食べた後でも逃げませんよ",
  "greeting.noon.e": "お昼。目にも十分休ませてあげて",
  "greeting.noon.f": "ごはんの時間です。キーボードを置きましょう",
  "greeting.noon.g": "お昼ですね。しっかり食べて、アイデアに力をつけよう",
  "greeting.noon.h": "昼間に進捗？いいですが、ごはんも忘れずに",
  "greeting.afternoon.a": "こんにちは。ここから先は任せてください",
  "greeting.afternoon.b": "午後ですね。調子が良さそうです",
  "greeting.afternoon.c": "午後ですね。飲み物を補給して、もう少し進めましょう",
  "greeting.afternoon.d": "午後のおやつタイム。進捗も一緒に押しましょう",
  "greeting.afternoon.e": "こんにちは。眠くなったら言ってください、ペース落とします",
  "greeting.afternoon.f": "午後はまだ長い。朝掘った穴を埋めましょう",
  "greeting.afternoon.g": "午後ですね。集中力が残っているなら、もう一项",
  "greeting.afternoon.h": "静かな午後はタスク整理に向いています",
  "greeting.evening.a": "こんばんは。やり残しはありますか？",
  "greeting.evening.b": "こんばんは。急がなくて大丈夫です",
  "greeting.evening.c": "こんばんは。今日の仕上げは他にありますか？",
  "greeting.evening.d": "寝る前に、今日の変更を commit しておきましょう",
  "greeting.evening.e": "こんばんは。残業代はありませんが、付き合いは無制限です",
  "greeting.evening.f": "夜の帳に、昼間避けていたリファクタリングを",
  "greeting.evening.g": "こんばんは。ごはんは食べましたか？先に食べましょう",
  "greeting.evening.h": "長い一日でした。残りは私が締めくくります",
  "greeting.night.a": "夜も更けました。無理はしないで",
  "greeting.night.b": "こんな時間まで？付き合いますよ",
  "greeting.night.c": "まだ起きてる？最後の一枚、終わったら寝る約束で",
  "greeting.night.d": "深夜は静か。本物のバグを見つけるのに向いています",
  "greeting.night.e": "夜が深い。セーブして、朝の自分に任せるのも手です",
  "greeting.night.f": "まだデバッグ？早く休んで、bug は逃げませんから",
  "greeting.night.g": "夜更かしモード起動。終わりまで付き合いますよ",
  "greeting.night.h": "深夜のひらめきは高価ですが、身体はもっと高価です",
  ...
  "status.connection.reconnecting": "ステータス - イベントストリーム切断、再接続中",
  ...
  "settings.agents.section.primary": "メインエージェント",
  ...
  // 260810 cc 语种裁剪至中日英后补齐 ja 缺口（此前相对 en 缺 84 key，parity.test 只测 2 个键没拦住）
  "theme.scheme.cream": "クリーム",
  "theme.scheme.green": "アイケアグリーン",
  "theme.scheme.deepblue": "ディープブルー",
  "command.project.previous": "前のプロジェクト",
  "command.project.next": "次のプロジェクト",
  "command.project.index": "プロジェクト {{index}} に切り替え",
  "command.settings.open.exportLogs": "ログをエクスポート",
  "session.child.promptDisabled": "サブエージェントのセッションには入力できません。",
  "session.child.backToParent": "メインセッションに戻る。",
  "dialog.mcp.toggleFailed": "MCP の切り替えに失敗しました",
  ...
  "notification.compacted.title": "コンテキストを圧縮しました",
  "notification.compacted.description": "{{before}} から {{after}} に圧縮しました",
  "home.title": "ホーム",
  "home.projects": "プロジェクト",
  "home.project.add": "プロジェクトを追加",
  "home.project.revealInExplorer": "ファイルマネージャーで表示",
  ...
  "home.view.list": "リスト表示",
  "home.view.kanban": "ボード表示",
  "home.kanban.working": "作業中",
  "home.kanban.attention": "要対応",
  "home.kanban.idle": "待機中",
  "home.kanban.empty": "セッションなし",
  "home.kanban.compacting": "圧縮中",
  ...
  "home.usage.tile.sessions": "セッション数",
  "home.usage.tile.messages": "リクエスト数",
  "home.usage.tile.output": "出力トークン",
  "home.usage.tile.cacheRead": "キャッシュ読取",
  "home.usage.tile.activeDays": "アクティブ日数",
  "home.usage.tile.currentStreak": "現在の連続",
  "home.usage.tile.longestStreak": "最長の連続",
  "home.usage.tile.peakHour": "ピーク時間",
  "home.usage.days": "{{count}}日",
  "home.usage.other": "その他",
  "home.stats.cacheHit": "キャッシュヒット",
  "home.stats.cost": "コスト",
  "home.stats.tokens.read": "読み取り",
  "home.stats.tokens.write": "書き込み",
  "home.stats.tokens.miss": "ミス",
  "home.stats.tokens.output": "出力",
  "home.shortcuts.search": "検索",
  "home.shortcuts.newSession": "新規セッション",
  "home.shortcuts.switchSession": "セッション切り替え",
  "home.shortcuts.fileTree": "ファイルツリー",
  "home.shortcuts.settings": "設定",
  "home.shortcuts.commandPalette": "コマンドパレット",
  "home.shortcuts.openProject": "プロジェクトを開く",
  "home.shortcuts.archiveSession": "セッションをアーカイブ",
  "home.shortcuts.cycleTheme": "テーマ切り替え",
  "home.shortcuts.switchProject": "プロジェクト切り替え",
  "session.tab.status": "ステータス",
  "session.tab.plan": "プラン",
  "session.tab.outline": "ターン",
  "session.outline.loading": "ターン一覧を読み込み中…",
  "session.outline.empty": "このセッションにはまだターンがありません",
  "session.outline.noPrompt": "（テキストなし）",
  "session.outline.unreachable": "そのターンまで遡れません（履歴が圧縮された可能性があります）",
  "session.review.noUncommittedChanges": "未コミットの変更はまだありません",
  "session.review.noBranchChanges": "ブランチの変更はまだありません",
  "session.plan.progress": "{{done}} / {{total}} 完了",
  "session.goal.title": "固定した目標",
  "session.goal.status.active": "進行中",
  "session.goal.status.done": "完了",
  "session.goal.status.blocked": "ブロック",
  "session.goal.status.budget_limited": "予算超過",
  "session.goal.status.cleared": "クリア済み",
  "session.goal.used": "この目標で {{tokens}} トークン消費",
  "session.goal.budget": "{{used}} / {{budget}} トークン · 自動継続 {{turn}}/{{max}} 回目",
  "session.plan.empty": "プランのステップはまだありません",
  "session.plan.inProgress": "進行中",
  "session.plan.done": "完了",
  "session.plan.pending": "未着手",
  "sidebar.empty.title": "開いているプロジェクトがありません",
  "sidebar.empty.description": "プロジェクトを開いて始めましょう",
  "settings.general.section.advanced": "詳細設定",
  "settings.general.section.tts": "読み上げ（TTS）",
