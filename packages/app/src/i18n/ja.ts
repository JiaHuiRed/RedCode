export const dict = {
  ...
  "settings.agents.description":
    "組み込みエージェントのモデル・推論レベル・タイムアウトを上書きします。「既定」は上書きせず、エージェント自身の定義に従います。",
  ...
  "settings.agents.timeout.title": "タイムアウト",
  "settings.agents.timeout.description": "サブエージェントの実行を打ち切り、フォールバックモデルで再試行します",
  "settings.agents.timeout.none": "既定（上書きしない）",
  "settings.agents.timeout.minutes": "{{count}} 分",
  "settings.agents.fallback.title": "フォールバックモデル",
  "settings.agents.fallback.description": "タイムアウト後にこのモデルで再試行します",
  "settings.agents.fallback.none": "既定（上書きしない）",
