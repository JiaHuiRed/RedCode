export const dict = {
  ...
  "session.new.greeting.morning.a": "おはようございます。どこから始めましょうか？",
  "session.new.greeting.morning.b": "おはよう。お茶でも淹れて、始めましょう",
  "session.new.greeting.noon.a": "こんにちは。先に何か食べますか？",
  "session.new.greeting.noon.b": "お昼ですね。少し休んでも大丈夫です",
  "session.new.greeting.afternoon.a": "こんにちは。ここから先は任せてください",
  "session.new.greeting.afternoon.b": "午後ですね。調子が良さそうです",
  "session.new.greeting.evening.a": "こんばんは。やり残しはありますか？",
  "session.new.greeting.evening.b": "こんばんは。急がなくて大丈夫です",
  "session.new.greeting.night.a": "夜も更けました。無理はしないで",
  "session.new.greeting.night.b": "こんな時間まで？付き合いますよ",
