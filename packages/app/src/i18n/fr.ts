export const dict = {
  ...
  "dialog.provider.RedCode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.RedCode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.RedCodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.RedCodeZen.visit.prefix": "Visitez ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " pour récupérer votre clé API.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans RedCode.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (RedCode.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'RedCode ne supporte pas encore l'authentification MCP.",
