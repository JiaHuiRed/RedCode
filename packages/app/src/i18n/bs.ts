export const dict = {
  ...
  "dialog.provider.RedCode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.RedCode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.RedCodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.RedCodeZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.RedCodeZen.visit.prefix": "Posjeti ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u RedCode.json",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (RedCode.json) provider/model names",
