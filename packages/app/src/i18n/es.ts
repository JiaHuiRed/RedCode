export const dict = {
  ...
  "dialog.provider.RedCode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.RedCode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.RedCodeGo.tagline": "Suscripción económica para todos",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.RedCodeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.RedCodeZen.visit.prefix": "Visita ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " para obtener tu clave API.",
  ...
  "dialog.plugins.empty": "Plugins configurados en RedCode.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de RedCode se conecta esta app.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de RedCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (RedCode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, RedCode no soporta autenticación MCP todavía.',
