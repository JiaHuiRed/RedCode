export const dict = {
  ...
  "dialog.provider.RedCode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.RedCode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.RedCodeGo.tagline": "Billigt abonnement for alle",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i RedCode.",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.RedCodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.RedCodeZen.visit.prefix": "Besøg ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i RedCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i RedCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i RedCode.json",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (RedCode.json) udbyder/modelnavne",
  ...
  "settings.general.row.colorScheme.description": "Vælg om RedCode følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan RedCode er temabestemt.",
