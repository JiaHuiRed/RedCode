...
export const dict = {
  ...
  "dialog.provider.RedCode.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.RedCode.tagline": "可靠的優化模型",
  "dialog.provider.RedCodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.RedCodeZen.line1": "RedCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.RedCodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.RedCodeZen.visit.prefix": "造訪 ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "dialog.plugins.empty": "在 RedCode.json 中設定的外掛程式",
  ...
  "context.stats.sessionID": "會話 ID",
  "context.stats.cacheTokens": "快取 token（讀/寫）",
  "context.stats.turnCacheHit": "單次命中率",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (RedCode.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: RedCode 暫不支援 MCP 認證。',
