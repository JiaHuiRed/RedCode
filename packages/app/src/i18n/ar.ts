export const dict = {
  ...
  "dialog.provider.RedCode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.RedCode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.RedCodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في RedCode.",
  ...
  "provider.connect.RedCodeZen.line1":
    "يمنحك RedCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.RedCodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في RedCode.json",
  ...
  "toast.update.description": "نسخة جديدة من RedCode ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (RedCode.json)",
