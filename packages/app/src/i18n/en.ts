export const dict = {
  ...
  "command.session.unarchive": "Unarchive",
  "home.sessions.archived.toggle": "Show archived sessions",
  ...
  "command.session.busyEnter": "Toggle busy message delivery",
  "command.session.busyEnter.description": "Steer (deliver mid-turn) / queue (wait for turn end)",
  "toast.busyEnter.steer.title": "Switched to steer",
  "toast.busyEnter.steer.description": "Messages sent while busy reach the model at the next step",
  ...
  "settings.general.row.image.description":
    "Which API the image tool calls. Switching providers is a setting, not a code change.",
  ...
  "settings.general.row.imageEndpoint.description":
    "Base URL, model id, and the auth entry the key comes from. The key itself is not stored here — use auth or REDCODE_IMAGE_API_KEY.",
  ...
  "dialog.provider.RedCode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.RedCode.tagline": "Reliable optimized models",
  "dialog.provider.RedCodeGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.RedCodeZen.line1":
    "RedCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.RedCodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.RedCodeZen.visit.prefix": "Visit ",
  "provider.connect.RedCodeZen.visit.link": "redcode.dev/zen",
  "provider.connect.RedCodeZen.visit.suffix": " to collect your API key.",
  ...
  "context.stats.inputTokens": "Input (uncached)",
  ...
  "context.stats.avgPerTurn": "Avg per turn",
  ...
  "error.chain.resources": "The project ran out of system resources. Close unused projects and retry.",
  "error.chain.processStart": "A project helper process could not start. Close unused projects and retry.",
  "error.chain.modelNotFound": "Model not found: {{provider}}/{{model}}",
  "error.chain.checkConfig": "Check your config (RedCode.json) provider/model names",
  ...
  "home.view.kanban": "Board view",
  "home.kanban.working": "Working",
  "home.kanban.attention": "Attention",
  "home.kanban.idle": "Idle",
  "home.kanban.empty": "No sessions",
  "home.kanban.compacting": "Compacting",
  "home.kanban.hidden": "{{count}} older sessions not shown",
  "home.usage.tab.overview": "Overview",
  "home.usage.tab.models": "Models",
  "home.usage.collapse": "Hide usage",
  "home.usage.expand": "Show usage",
  "home.usage.range.all": "All",
  "home.usage.range.30d": "30d",
  "home.usage.range.7d": "7d",
  "home.usage.tile.sessions": "Sessions",
  "home.usage.tile.messages": "Requests",
  "home.usage.tile.output": "Output tokens",
  "home.usage.tile.cacheRead": "Cache read",
  "home.usage.tile.activeDays": "Active days",
  "home.usage.tile.currentStreak": "Current streak",
  "home.usage.tile.longestStreak": "Longest streak",
  "home.usage.tile.peakHour": "Peak hour",
  "home.usage.days": "{{count}}d",
  "home.usage.other": "Other",
  ...
  "session.tab.outline": "Turns",
  "session.outline.loading": "Loading turn outline…",
  ...
  "session.goal.status.done": "Done",
  "session.goal.status.blocked": "Blocked",
  "session.goal.status.budget_limited": "Budget spent",
  "session.goal.status.cleared": "Cleared",
  "session.goal.used": "{{tokens}} tokens spent on this goal",
  "session.goal.budget": "{{used}} / {{budget}} tokens · auto-continue turn {{turn}}/{{max}}",
  "session.plan.empty": "No plan steps yet",
  "session.plan.inProgress": "in progress",
  "session.plan.done": "done",
  "session.plan.pending": "pending",
  ...
  "greeting.morning.a": "Good morning. Where shall we start?",
  "greeting.morning.b": "Morning. Grab a coffee, then let us begin.",
  "greeting.morning.c": "Morning. Which line of code shall we start with?",
  "greeting.morning.d": "Good morning. Yesterday's mess is still warm.",
  "greeting.morning.e": "Up already? Fresh brain — hardest task first.",
  "greeting.morning.f": "Morning. Coffee or tea — pick one, and we begin.",
  "greeting.morning.g": "Good morning. What are we tackling first today?",
  "greeting.morning.h": "The morning is young. Save point ready.",
  "greeting.noon.a": "Good afternoon. Lunch first, or shall we dive in?",
  "greeting.noon.b": "Midday already. A short break costs nothing.",
  "greeting.noon.c": "Noon. Food first — the code can wait.",
  "greeting.noon.d": "Lunchtime. The bug will still be there after you eat.",
  "greeting.noon.e": "Midday. Your eyes deserve ten minutes too.",
  "greeting.noon.f": "It is lunch o'clock. Put the keyboard down.",
  "greeting.noon.g": "Midday. Eat well — inspiration needs fuel.",
  "greeting.noon.h": "Sneaking in progress? Fine, but eat something.",
  "greeting.afternoon.a": "Good afternoon. I will take it from here.",
  "greeting.afternoon.b": "Afternoon. You seem to be in the zone.",
  "greeting.afternoon.c": "Afternoon. Refill the cup, keep the momentum.",
  "greeting.afternoon.d": "Afternoon tea time. Push a little progress while you are at it.",
  "greeting.afternoon.e": "Good afternoon. Say the word if you are sleepy — I will slow down.",
  "greeting.afternoon.f": "The afternoon is long enough to fill the holes dug this morning.",
  "greeting.afternoon.g": "Afternoon. Focus still there? One more task, then.",
  "greeting.afternoon.h": "Quiet afternoons are for clearing the checklist.",
  "greeting.evening.a": "Good evening. Anything left to wrap up?",
  "greeting.evening.b": "Evening. No rush, take your time.",
  "greeting.evening.c": "Good evening. Anything else before clock-out?",
  "greeting.evening.d": "Before bed, let us commit today's changes.",
  "greeting.evening.e": "Evening. No overtime pay here, but company is unlimited.",
  "greeting.evening.f": "Nightfall — perfect for the refactor you dodged all day.",
  "greeting.evening.g": "Good evening. Eaten yet? Eat first.",
  "greeting.evening.h": "Long day. Leave the rest of the wrap-up to me.",
  "greeting.night.a": "It is late. Do not stay up too long.",
  "greeting.night.b": "Still at it this late? I will keep you company.",
  "greeting.night.c": "Still up? One last task, then sleep. Promise?",
  "greeting.night.d": "Late nights are quiet — good for catching real bugs.",
  "greeting.night.e": "Deep night. Save your work; tomorrow-You may see it better.",
  "greeting.night.f": "Still debugging? Rest early — the bug is not going anywhere.",
  "greeting.night.g": "Night-owl mode engaged. I will stay until we are done.",
  "greeting.night.h": "Midnight inspiration is precious, but sleep is more so. Pace yourself.",
  ...
  "settings.general.row.font.undefined": "Default (System)",
