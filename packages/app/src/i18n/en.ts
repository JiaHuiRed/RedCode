export const dict = {
  ...
  "settings.agents.timeout.title": "Timeout",
  "settings.agents.timeout.description": "Cancel a subagent run and retry it with the fallback model",
  "settings.agents.timeout.none": "Default (don't override)",
  "settings.agents.timeout.minutes": "{{count}} min",
  "settings.agents.fallback.title": "Fallback model",
  "settings.agents.fallback.description": "Retried with this model after a subagent times out",
  "settings.agents.fallback.none": "Default (don't override)",
