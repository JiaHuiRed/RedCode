export const dict = {
  ...
  "session.new.greeting.morning.a": "Good morning. Where shall we start?",
  "session.new.greeting.morning.b": "Morning. Grab a coffee, then let us begin.",
  "session.new.greeting.noon.a": "Good afternoon. Lunch first, or shall we dive in?",
  "session.new.greeting.noon.b": "Midday already. A short break costs nothing.",
  "session.new.greeting.afternoon.a": "Good afternoon. I will take it from here.",
  "session.new.greeting.afternoon.b": "Afternoon. You seem to be in the zone.",
  "session.new.greeting.evening.a": "Good evening. Anything left to wrap up?",
  "session.new.greeting.evening.b": "Evening. No rush, take your time.",
  "session.new.greeting.night.a": "It is late. Do not stay up too long.",
  "session.new.greeting.night.b": "Still at it this late? I will keep you company.",
