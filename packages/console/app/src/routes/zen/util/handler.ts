...
import { and, Database, eq, isNull, lt, or, sql } from "@redcode-ai/console-core/drizzle/index.js"
import { KeyTable } from "@redcode-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@redcode-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@redcode-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@redcode-ai/console-core/util/date.js"
import { Identifier } from "@redcode-ai/console-core/identifier.js"
import { Billing } from "@redcode-ai/console-core/billing.js"
import { Actor } from "@redcode-ai/console-core/actor.js"
import { WorkspaceTable } from "@redcode-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@redcode-ai/console-core/model.js"
import { Subscription } from "@redcode-ai/console-core/subscription.js"
import { BlackData } from "@redcode-ai/console-core/black.js"
import { UserTable } from "@redcode-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@redcode-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@redcode-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@redcode-ai/console-core/lite.js"
import { Resource } from "@redcode-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-RedCode-session") ?? ""
    const requestId = input.request.headers.get("x-RedCode-request") ?? ""
    const ocClient = input.request.headers.get("x-RedCode-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-RedCode-request")
          headers.delete("x-RedCode-session")
          headers.delete("x-RedCode-project")
          headers.delete("x-RedCode-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://redcode.dev/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://redcode.dev/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://redcode.dev/workspace/${authInfo.workspaceID}/members`
