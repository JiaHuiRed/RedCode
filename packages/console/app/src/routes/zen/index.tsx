...
import compareVideo from "../../asset/lander/RedCode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/RedCode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="RedCode:auth" content={loggedin() ? "true" : "false"} />
