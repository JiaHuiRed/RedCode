...
import desktopAppIcon from "../../asset/lander/RedCode-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://redcode.dev/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>redcode.dev/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g RedCode-ai")}>
                <code>
                  npm i -g <strong>RedCode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g RedCode-ai")}>
                <code>
                  bun add -g <strong>RedCode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install JiaHuiRed/tap/redcode")}>
                <code>
                  brew install <strong>JiaHuiRed/tap/redcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S RedCode")}>
                <code>
                  paru -S <strong>RedCode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask RedCode-desktop")}>
                <code>
                  brew install --cask <strong>RedCode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
