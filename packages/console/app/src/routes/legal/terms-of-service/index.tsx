...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>RedCode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="RedCode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to RedCode. Please read on to learn the rules and restrictions that govern your use of
                RedCode&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("RedCode," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://redcode.dev/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-RedCode">What is RedCode?</h2>
              <p>
                RedCode is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the RedCode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, RedCode enables you to
              ...
              <p>
                ...
                our site located at redcode.dev, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                RedCode takes the privacy of its users very seriously. For the current RedCode Privacy Policy, please
                click here{" "}
                <a href="https://redcode.dev/legal/privacy-policy">https://redcode.dev/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using RedCode?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by RedCode;
                </li>
                <li>
              ...
              <p>
                If you use RedCode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                RedCode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                RedCode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-RedCode-ever-change-the-services">Will RedCode ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://redcode.dev/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://redcode.dev/auth">https://redcode.dev/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://redcode.dev/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                RedCode is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. RedCode has the sole right to decide whether you are
              ...
              <p>
                RedCode and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (RedCode and all such
                parties together, the "RedCode Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the RedCode Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The RedCode Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY REDCODE (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                REDCODE PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO REDCODE IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the RedCode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without RedCode's prior written
              ...
              <p>
                ...
                disputes and claims with RedCode and limits the manner in which you can seek relief from RedCode. Both
                you and RedCode acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, RedCode's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. RedCode will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. RedCode will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or RedCode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND REDCODE WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and RedCode are instead choosing to have claims and disputes resolved by
                ...
                you and RedCode over whether to vacate or enforce an arbitration award, YOU AND REDCODE WAIVE ALL
              ...
              <p>
                ...
                RedCode is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or RedCode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and RedCode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the RedCode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and RedCode agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and RedCode, and
                ...
                are not an employee, agent, partner, or joint venture of RedCode, and you do not have any authority of
                any kind to bind RedCode in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and RedCode
