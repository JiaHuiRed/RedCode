...
import { reasoningTitle, use思考中Mode } from "@tui/context/thinking"
...
function CollapsedReasoningText(props: { title: string | null }) {
  ...
  return (
    <text fg={theme.warning} wrapMode="none">
      <span style={{ fg: theme.warning, italic: true }}>{props.title ? "+ 已思考: " + props.title : "+ Thought"}</span>
    </text>
  )
}
...
function Grep(props: ToolProps) {
  return (
    <InlineTool icon="✱" pending="搜索内容中..." complete={toolComplete(props.part)} part={props.part}>
