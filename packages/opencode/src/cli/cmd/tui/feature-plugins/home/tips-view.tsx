...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at redcode.dev",
  ...
  (shortcuts) => press(shortcuts.modelCycle最近(), "to quickly switch between recently used models"),
  ...
  "Create {highlight}redcode.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "Use {highlight}/redcode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}redcode github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/redcode fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/JiaHuiRed/redcode{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with RedCode Zen for curated, tested models",
