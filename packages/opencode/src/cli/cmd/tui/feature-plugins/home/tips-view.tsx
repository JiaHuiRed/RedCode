...
const TIPS: Tip[] = [
  ...
  "在 {highlight}.redcode/commands/{/highlight} 中添加 {highlight}.md{/highlight} 文件可定义可复用的自定义指令",
  ...
  "在 {highlight}.redcode/agents/{/highlight} 中添加 {highlight}.md{/highlight} 文件可定义专门的 AI 人格",
  ...
  "在 {highlight}.redcode/tools/{/highlight} 中创建 {highlight}.ts{/highlight} 文件可定义新的 LLM 工具",
  "工具定义可调用 Python、Go 等语言编写的脚本",
  "在 {highlight}.redcode/plugins/{/highlight} 中添加 {highlight}.ts{/highlight} 文件可创建事件钩子",
  "可用插件在会话完成时发送系统通知",
  ...
  "在 {highlight}.redcode/themes/{/highlight} 目录下创建 JSON 主题文件",
  "主题支持暗色/亮色两种模式变体",
