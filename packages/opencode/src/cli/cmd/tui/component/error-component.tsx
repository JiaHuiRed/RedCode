...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/JiaHuiRed/RedCode/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("redcode-version", InstallationVersion)
  ...
  return (
    <box flexDirection="column" gap={1} backgroundColor={colors.bg}>
      <box flexDirection="row" gap={1} alignItems="center">
        ...
        {copied() && <text fg={colors.muted}>已复制</text>}
      </box>
      <box flexDirection="row" gap={2} alignItems="center">
        <text fg={colors.text}>发生了致命错误！</text>
