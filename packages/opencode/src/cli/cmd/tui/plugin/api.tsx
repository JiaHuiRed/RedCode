import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition, TuiSlotProps } from "@redcode-ai/plugin/tui"
...
export function createTuiApi(input: Input): TuiPluginApi {
  ...
  return {
    ...
    keymap: input.keymap as unknown as TuiPluginApi["keymap"],
    mode: {
      current() {
