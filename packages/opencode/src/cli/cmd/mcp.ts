...
async function resolveConfigPath(baseDir: string, global = false) {
  ...
  const candidates = [path.join(baseDir, "redcode.json"), path.join(baseDir, "redcode.jsonc")]

  if (!global) {
    candidates.push(path.join(baseDir, ".redcode", "redcode.json"), path.join(baseDir, ".redcode", "redcode.jsonc"))
  }
