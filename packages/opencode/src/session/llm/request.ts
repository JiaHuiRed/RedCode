...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const redcodeProjectID = input.model.providerID.startsWith("redcode")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("redcode")
        ? {
            ...(redcodeProjectID ? { "x-redcode-project": redcodeProjectID } : {}),
            "x-redcode-session": input.sessionID,
            "x-redcode-request": input.user.id,
            "x-redcode-client": input.flags.client,
