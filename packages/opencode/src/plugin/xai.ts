...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=redcode` lets xAI attribute redcode-originated
...
<html>
  <head>
    <title>RedCode - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to RedCode.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>RedCode - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
async function startOAuthServer(): Promise<{ port: number; redirectUri: string }> {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    server.listen(OAUTH_PORT, OAUTH_HOST, () => {
      ...
      // behavior and crash the entire redcode process. Matches the silent-
