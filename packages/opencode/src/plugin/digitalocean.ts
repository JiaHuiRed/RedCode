...
const MAK_NAME_PREFIX = "redcode-oauth"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>RedCode - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to RedCode."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              ...
              instructions:
                "Sign in to DigitalOcean in your browser. RedCode will create a Model Access Key named redcode-oauth-* and load your Inference Routers. Re-run /connect to refresh routers later.",
