...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.REDCODE_WORKSPACE_ID ? WorkspaceID.make(Flag.REDCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-redcode-directory"] || process.cwd()
}
