...
Usage notes:
  ...
  - You can specify an optional timeout in milliseconds (maximum 600000ms / 10 minutes; larger values are clamped). If not specified, commands will time out after 120000ms (2 minutes).
