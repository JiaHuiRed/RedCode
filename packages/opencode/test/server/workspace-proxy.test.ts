...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips redcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-redcode-directory"]).toBeUndefined()
      expect(forwarded["x-redcode-workspace"]).toBeUndefined()
