...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips redcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-redcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-redcode-directory")).toBeNull()
      expect(result.get("x-redcode-workspace")).toBeNull()
