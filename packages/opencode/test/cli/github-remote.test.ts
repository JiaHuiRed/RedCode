...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/redcode.git")).toEqual({ owner: "sst", repo: "redcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/redcode")).toEqual({ owner: "sst", repo: "redcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/redcode.git")).toEqual({ owner: "sst", repo: "redcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/redcode")).toEqual({ owner: "sst", repo: "redcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/redcode.git")).toEqual({ owner: "sst", repo: "redcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/redcode")).toEqual({ owner: "sst", repo: "redcode" })
})
