  ...
  scout.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "redcode-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "redcode-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "redcode-glob-reference/repo",
        },
      },
    },
  )
